...
class GoogleSafeBrowsingService {
  final String apiKey = 'AIzaSyAl7HTLg5_0Iqc18Y0VzCDgTiE_mvTvmmE'; // Replace with your API key

  // Safe Browsing API endpoint
  final String endpoint = 'https://safebrowsing.googleapis.com/v4/threatMatches:find';
  ...
  Future<bool> isUrlSafe(String url) async {
    try {
      ...
      Map<String, dynamic> requestBody = {
        ...
        "threatInfo": {
          "threatTypes": ["MALWARE", "PHISHING"], // You can add more threat types if needed
